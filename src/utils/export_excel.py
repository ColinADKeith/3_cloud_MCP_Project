...
def generate_production_excel():
    ...
    # Styling Palettes
    PRIMARY_COLOR = "1F4E78"  # Dark Slate Blue
    ACCENT_COLOR = "D9E1F2"   # Muted Blue Highlight
    ...
    # Calculate source platform distributions dynamically
    counts = {}
    for j in jobs:
    ...
    data_headers = ["Job ID", "Job Title", "Company", "Location", "Source", "Semantic Distance", "Portal Link URL"]
    ...
    # Add Conditional Formatting Scale (Green for tighter semantic match bounds)
